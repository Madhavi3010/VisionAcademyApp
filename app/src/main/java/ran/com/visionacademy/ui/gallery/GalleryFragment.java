package ran.com.visionacademy.ui.gallery;
...
public class GalleryFragment extends Fragment {
    ...
    RecyclerView convoRecycler, independentRecycler, otherRecycler;
    ...
    private void getIndependentImage() {
        reference.child("Independence Day").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                independentRecycler.setLayoutManager(new GridLayoutManager(getContext(), 2));
