...
public class StudentActivity extends AppCompatActivity {
    ...
    private void setToolbar() {
        ...
        TextView title = toolbar1.findViewById(R.id.title_toolbar);
        subtitle = toolbar1.findViewById(R.id.subtitle_toolbar);
        ImageButton back = toolbar1.findViewById(R.id.back);
        ImageButton save = toolbar1.findViewById(R.id.save);
        ...
        toolbar1.inflateMenu(R.menu.student_menu);
        toolbar1.setOnMenuItemClickListener(menuItem -> onMenuItemClick(menuItem));
    ...
    private boolean onMenuItemClick(MenuItem menuItem) {
        if (menuItem.getItemId() == R.id.add_student) {
            ...
            openSheetList();
        } else if (menuItem.getItemId() == R.id.logout_attendance) {
            openAttendanceLogin();
        }
        return true;
    }

    private void openAttendanceLogin() {
        finish();
        startActivity(new Intent(StudentActivity.this, AttendanceLoginActivity.class));
    }
